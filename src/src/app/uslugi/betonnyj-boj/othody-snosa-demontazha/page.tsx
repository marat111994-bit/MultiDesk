...
const subcategory = betonnyjBoj.subcategories.find(
  (s) => s.id === "othody-snosa-demontazha"
)!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: subcategory.seo.title,
    description: subcategory.seo.description,
    url: "https://danmax.moscow/uslugi/betonnyj-boj/othody-snosa-demontazha/",
    siteName: "DanMax",
    locale: "ru_RU",
    type: "website",
  },
  alternates: {
    canonical: "https://danmax.moscow/uslugi/betonnyj-boj/othody-snosa-demontazha/",
  },
};

export default function OthodySnosaDemontazhaPage() {
  ...
  return (
    <>
      ...
      <WhyUs
        title="Почему выбирают DanMax для вывоза отходов сноса"
        advantages={subcategory.advantages}
        image="/images/why-us/othody-snosa.svg"
        imageAlt="Вывоз отходов сноса"
      />
      ...
      <HowWeWork
        title="Как заказать вывоз отходов сноса — 5 шагов"
        steps={steps}
      />

      <section id="pricing">
        <PricingTable
          title="Цены на вывоз отходов сноса и демонтажа"
          rows={subcategory.pricing}
          disclaimer="Минимальный заказ — контейнер 27 м³."
          ctaText="Рассчитать точную стоимость"
        />
      </section>

      <CalculatorEmbed
        title="Рассчитайте стоимость вывоза отходов сноса онлайн"
        subtitle="Онлайн-калькулятор для расчёта стоимости вывоза и утилизации"
        preselectedService="othody-snosa-demontazha"
        variant="embedded"
      />
      ...
      <CasesSection
        title="Наши проекты по вывозу отходов сноса"
        cases={[]}
        clients={clients}
      />

      <FaqSection
        title="Частые вопросы о вывозе отходов сноса"
      ...
      <ContactForm
        ...
        preselectedService="Отходы сноса"
        variant="full"
      />
    </>
  );
