...
const subcategory = kirpichnyjBoj.subcategories.find(
  (s) => s.id === "stroitelnyj-kirpichnyj-boj"
)!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: subcategory.seo.title,
    description: subcategory.seo.description,
    url: "https://danmax.moscow/uslugi/kirpichnyj-boj/stroitelnyj-kirpichnyj-boj/",
    siteName: "DanMax",
    locale: "ru_RU",
    type: "website",
  },
  alternates: {
    canonical: "https://danmax.moscow/uslugi/kirpichnyj-boj/stroitelnyj-kirpichnyj-boj/",
  },
};

export default function StroitelnyjKirpichnyjBojPage() {
  ...
  return (
    <>
      ...
      <WhyUs
        title="Почему выбирают DanMax для вывоза строительного кирпичного боя"
        advantages={subcategory.advantages}
        image="/images/why-us/stroitelnyj-kirpichnyj-boj.svg"
        imageAlt="Вывоз строительного кирпичного боя"
      />
      ...
      <section className="py-20 bg-white">
        <Container>
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">
            Коды ФККО для строительного кирпичного боя
          </h2>
      ...
      <HowWeWork
        title="Как заказать вывоз строительного кирпичного боя — 5 шагов"
        steps={steps}
      />

      <section id="pricing">
        <PricingTable
          title="Цены на вывоз строительного кирпичного боя"
      ...
      <CalculatorEmbed
        ...
        preselectedService="stroitelnyj-kirpichnyj-boj"
        variant="embedded"
      />
      ...
      <CasesSection
        ...
        cases={clients.length > 0 ? [] : []}
        clients={clients}
      />

      <FaqSection
        title="Частые вопросы о вывозе строительного кирпичного боя"
      ...
      <ContactForm
        ...
        preselectedService="Строительный кирпичный бой"
        variant="full"
      />
    </>
  );
