...
const subcategory = kirpichnyjBoj.subcategories.find(
  (s) => s.id === "ogneupornyj-promyshlennyj-kirpich"
)!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: subcategory.seo.title,
    description: subcategory.seo.description,
    url: "https://danmax.moscow/uslugi/kirpichnyj-boj/ogneupornyj-promyshlennyj-kirpich/",
    siteName: "DanMax",
    locale: "ru_RU",
    type: "website",
  },
  alternates: {
    canonical: "https://danmax.moscow/uslugi/kirpichnyj-boj/ogneupornyj-promyshlennyj-kirpich/",
  },
};

export default function OgneupornyjPromyshlennyjKirpichPage() {
  const relatedSubcategories = kirpichnyjBoj.subcategories.filter((s) =>
  ...
  return (
    <>
      <Container>
        <Breadcrumbs
          items={[
            ...
            { label: "Кирпичный бой", href: "/uslugi/kirpichnyj-boj/" },
      ...
      <WhyUs
        title="Почему выбирают DanMax для вывоза огнеупорного кирпича"
        advantages={subcategory.advantages}
        image="/images/why-us/ogneupornyj-kirpich.jpg"
        imageAlt="Вывоз огнеупорного кирпича"
      />
      ...
      <section className="py-20 bg-white">
        <Container>
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">
            Коды ФККО для огнеупорного промышленного кирпича
          </h2>
      ...
      <HowWeWork
        title="Как заказать вывоз огнеупорного кирпича — 5 шагов"
        steps={steps}
      />

      <section id="pricing">
        <PricingTable
          title="Цены на вывоз огнеупорного промышленного кирпича"
          rows={subcategory.pricing}
          disclaimer="Минимальный заказ — 10 м³. Требуется паспорт отходов III–IV класса."
          ctaText="Рассчитать точную стоимость"
        />
      </section>

      <CalculatorEmbed
        title="Рассчитайте стоимость вывоза огнеупорного кирпича онлайн"
        subtitle="Онлайн-калькулятор для расчёта стоимости вывоза и утилизации"
        preselectedService="ogneupornyj-promyshlennyj-kirpich"
        variant="embedded"
      />
      ...
      <CasesSection
        title="Наши проекты по вывозу огнеупорного кирпича"
        cases={[]}
        clients={clients}
      />

      <FaqSection
        title="Частые вопросы о вывозе огнеупорного кирпича"
      ...
      <ContactForm
        ...
        preselectedService="Огнеупорный кирпич"
        variant="full"
      />
    </>
  );
