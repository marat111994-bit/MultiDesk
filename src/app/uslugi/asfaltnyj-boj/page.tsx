...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: service.seo.title,
    description: service.seo.description,
    url: "https://danmax.moscow/uslugi/asfaltnyj-boj/",
    siteName: "DanMax",
    locale: "ru_RU",
    type: "website",
  },
  alternates: {
    canonical: "https://danmax.moscow/uslugi/asfaltnyj-boj/",
  },
};

export default function AsfaltnyjBojPage() {
  return (
    <>
      <Container>
        <Breadcrumbs
      ...
      <WhyUs
        title="Почему выбирают DanMax для вывоза асфальтового боя"
        advantages={service.advantages}
        image="/images/why-us/asfaltnyj-boj.jpg"
        imageAlt="Вывоз асфальтового боя DanMax"
      />

      <HowWeWork
        title="Как заказать вывоз асфальтового боя — 5 шагов"
        steps={steps}
      />

      <section id="pricing">
        <PricingTable
          title="Цены на вывоз асфальтового боя в Москве"
      ...
      {/* ФККО Таблица для услуги без подкатегорий */}
      <section className="py-20 bg-white">
        <Container>
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">
            Коды ФККО для асфальтового боя
          </h2>
      ...
      <CalculatorEmbed
        title="Рассчитайте стоимость вывоза асфальтового боя онлайн"
        subtitle="Онлайн-калькулятор для расчёта стоимости вывоза и утилизации"
        preselectedService="asfaltnyj-boj"
        variant="embedded"
      />

      <CasesSection
        title="Наши проекты по вывозу асфальтового боя"
        cases={cases.filter((c) => c.serviceType === "asfaltnyj-boj")}
        clients={clients}
      />

      <FaqSection
        title="Частые вопросы о вывозе асфальтового боя"
        items={service.faq}
      />
      ...
      <ContactForm
        ...
        preselectedService="Асфальтовый бой"
        variant="full"
      />
    </>
  );
