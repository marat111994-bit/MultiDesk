...
export function Footer() {
  ...
  const services = servicesItem?.children || [];
      ...
      <div className="mx-auto w-full max-w-[1280px] px-4 md:px-8 xl:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Вывоз и утилизация строительных отходов в Москве и Московской
              области. Собственный автопарк, все лицензии.
            </p>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex items-center justify-center w-10 h-10 bg-gray-800 rounded-lg hover:bg-primary-500 transition-colors"
                aria-label="Telegram"
              >
                <svg
          ...
          <div className="space-y-4">
            ...
            {/* Режим работы */}
            <p className="text-sm">{contacts.workingHours}</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 pb-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm">
              &copy; 2025 DanMax. Все права защищены.
            </p>
